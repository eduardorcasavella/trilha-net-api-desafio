...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        {
            // FEITO: Buscar o Id no banco utilizando o EF - ok
            var tarefa = _context.Tarefas.Find(id);
            // FEITO Validar o tipo de retorno. Se não encontrar a tarefa, retornar NotFound, - ok
            if(tarefa == null)
                return NotFound();
        ...
        public IActionResult ObterTodos()
        {
            ...
            var tarefas = _context.Tarefas.Where(x=> x.Titulo != null);
            return Ok(tarefas);
        }
        ...
        public IActionResult Criar(Tarefa tarefa)
        {
            ...
            // FEITO: Adicionar a tarefa recebida no EF e salvar as mudanças (save changes) -OK
            _context.Add(tarefa);
        ...
        public IActionResult Deletar(int id)
        {
            ...
            if (tarefaBanco == null)
             ...
             //FEITO: Remover a tarefa encontrada através do EF e salvar as mudanças (save changes) -ok
